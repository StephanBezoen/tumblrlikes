 ...
 */
class UnhiddenFilterOptionImpl constructor(photoEntityDao: PhotoEntityDao): AbstractFilterOptionImpl() {
    override val queryBuilder: QueryBuilder<PhotoEntity> by lazy {
        photoEntityDao.queryBuilder().where(PhotoEntityDao.Properties.IsHidden.eq(false))
    }
}